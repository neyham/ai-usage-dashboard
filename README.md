...
Version `0.8.6` is the current multi-platform release: Windows (WinGet + NSIS),
...
Pin a version with `VERSION=0.8.6` before the install script, for example
`VERSION=0.8.6 sh install-linux.sh`.
